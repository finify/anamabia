...
<header class="main-header header-style-one">
					...
					<div class="header-contact-info-style1">
						<ul>
							<li>
								...
								<div class="text">
									<p>Adonai Plaza #5 Airport Road Eneka Port Harcourt</p>
								</div>
							</li>
							<li>
								<div class="icon">
								...
								<div class="text">
									<p><a href="mailto:yourmail@email.com">info@anamabia.com</a></p>
								</div>
							</li>
							<li>
								<div class="icon">
			...
			<div class="clearfix">
				...
				<div class="logo float-left">
					<a href="/" class="img-responsive">
						<img src="homeassets/images/anamabialogo.png" width="70px" alt="" title="">
					</a>
				</div>
				<!--Right Col-->
	...
	<div class="mobile-menu">
		...
		<nav class="menu-box">
			<div class="nav-logo"><a href="/"><img src="homeassets/images/anamabiawhitelogo.png" alt="" width="100px" title=""></a></div>
