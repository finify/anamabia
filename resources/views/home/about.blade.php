...
<!--Start Partner Area-->
<section class="partner-area" style="margin-top: 150px;">
	<div class="container">
		<div class="sec-title">
			<div class="sub-title">
				<h3>Our Clients</h3>
			...
			<div class="inner">
				<ul class="partner-box partner-carousel owl-carousel owl-theme owl-dot-style1 rtl-carousel">
					...
					<li class="single-partner-logo-box">
						<a href="#"><img src="homeassets/images/brand/riwama.png" alt="Awesome Image"></a>
					</li>
					...
					<!--Start Single Partner Logo Box-->
					<!-- <li class="single-partner-logo-box">
						<a href="#"><img src="homeassets/images/brand/brand-logo-4.png" alt="Awesome Image"></a>
					</li> -->
					<!--End Single Partner Logo Box-->
				</ul>
			</div>
...
<section class="features-style3-area">
	<div class="features-style3__bg" style="background-image: url(homeassets/images/parallax-background/features-v3-bg.jpg);"></div>
	<div class="container">
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-xl-4 col-lg-4">
				<div class="single-team-style1">
					<div class="img-holder">
						<div class="inner">
							<img src="homeassets/images/team/team-v1-3.jpg" alt="" />
						</div>
						<div class="title-holder text-center">
