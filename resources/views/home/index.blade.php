	...
	<section class="main-slider style1">
            <div class="slider-box">
                ...
                <div class="banner-carousel owl-theme owl-carousel">
                    <!-- Slide -->
                    <div class="slide">
                        <div class="image-layer" style="background-image:url(homeassets/images/slides/slide-v1-1.jpg)">
                        </div>
                    ...
                    <!-- Slide -->
                    <div class="slide">
                        <div class="image-layer" style="background-image:url(homeassets/images/slides/slide-v1-2.jpg)">
                        </div>
                        <div class="auto-container">
                            <div class="content">
                                <div class="sub-title">
                    ...
                    <div class="col-xl-6">
                        <div class="about-style1__image clearfix">
                            ...
                            <ul>
                                <!-- <li>
                                    <div class="img-box">
                                        <img src="homeassets/images/about/about-style1__image-1.jpg" alt="">
                                    </div>
                                </li> -->
                                <li>
                                    <div class="img-box">
                                        ...
                                        <!-- <div class="col-xl-6 col-lg-6 col-md-6">
                                            <div class="video-gallery-style1">
                                                <div class="video-gallery-style1__bg"
                                                    style="background-image: url(homeassets/images/resources/video-gallery-style1-bg.jpg);">
                                                </div>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="service-style1__top">
                            <div class="service-style1__top-title">
                                ...
                                <div class="text">
                                    <p>A forward looking company going beyond boundaries.</p>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="single-service-style1">
                            <div class="inner">
                                ...
                                <div class="text">
                                    <h3>Dumpsite <br>  management</h3>
                                    <p>We maintain the highest standards of environmental responsibility.</p>
                                </div>
                            </div>
                            <div class="btn-box">
                                <a href="javascript: void(0)"><span class="icon-right-arrow"></span></a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="single-service-style1">
                            <div class="inner">
                                ...
                                <div class="text">
                                    <h3>Waste <br> Recycling</h3>
                                    <p>We collect, sort, and process recyclables, turning trash into valuables</p>
                                </div>
                            </div>
                            <div class="btn-box">
                                <a href="javascript: void(0)"><span class="icon-right-arrow"></span></a>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="single-features-style2-box">
                            <div class="inner-content">
                                ...
                                <div class="title">
                                    <h3>Why Choose Us</h3>
                                    <h2>Sustainable Waste Solutions Every Day</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="single-features-style2-box left">
                            <div class="inner-content">
                                ...
                                <div class="title">
                                    <h3>Our Mission</h3>
                                    <h2> A forward looking company going beyond boundaries </h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8">
                        <div class="video-gallery-style2">
                            <div class="video-gallery-style2__bg"
                                style="background-image: url(homeassets/images/resources/video-gallery-style2-bg.jpg);">
                            </div>
            ...
            <div class="auto-container">
                <div class="home1-page-map-outer">
                    ...
                    <!-- <div class="map-canvas" data-zoom="12" data-lat="-37.817085" data-lng="144.955631"
                        ...
                        data-icon-path="homeassets/images/icon/map-marker.png"
